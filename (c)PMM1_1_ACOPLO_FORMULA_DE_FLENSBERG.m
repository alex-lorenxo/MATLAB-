syms W_1L W_R2 epsilon_1 epsilon_2 Delta E q h real
...
G_subs = subs(G_sym, ...
    ...
    [1.602e-19, 6.626e-34, 8*gamma, 8*gamma, 3.141592653589793, 8*gamma]);
...
lgd = legend("\epsilon_{1} = 0, \epsilon_{2} = 0, \Delta = 8\Gamma, t = 8\Gamma", ...
    "\epsilon_{1} = 4\Gamma, \epsilon_{2} = 4\Gamma, \Delta = 8\Gamma, t = 8\Gamma", ...
    "\epsilon_{1} = 8\Gamma, \epsilon_{2} = 8\Gamma, \Delta = 8\Gamma, t = 8\Gamma"); 
